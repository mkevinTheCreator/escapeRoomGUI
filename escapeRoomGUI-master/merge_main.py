...
font_path = base_dir / "fonts" / "Geostar-Regular.ttf"
...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        self.changePageSignal.connect(onSolved)
        ...
        self.effect.setSource(QUrl.fromLocalFile("escapeRoomGUI-master\\media\\sounds\\dial2.wav"))
        self.effect.setVolume(0.5)
        self.effectSolved = QSoundEffect()
        self.effectSolved.setSource(QUrl.fromLocalFile("escapeRoomGUI-master\\media\\sounds\\solved.wav"))
        self.effectSolved.setVolume(0.4)
        ...
        numberA.resize(50, 60)
        numberA.setMaxLength(1)
        numberA.setMaximumSize(50, 60)
        numberA.setAlignment(Qt.AlignCenter)
        numberA.setStyleSheet("color:white;")
        ...
        SFormAnfang.setStyleSheet("color:white;")
        ...
        numberB.resize(50, 60)
        numberB.setMaxLength(2)
        numberB.setMaximumSize(50, 60)
        numberB.setStyleSheet("color:white;")
        ...
        SFormMitte.setStyleSheet("color:white;")
        ...
        SFormHoch.setStyleSheet("color:white;")
        ...
        numberC.resize(50, 60)
        numberC.setMaxLength(2)
        numberC.setMaximumSize(50, 60)
        numberC.setStyleSheet("color:white;")
